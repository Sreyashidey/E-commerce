...
if($_POST){
	...
	$ins="insert into categories(cat_name,cat_description,cat_image,parent_id) values ('$cat_name','$cat_desc','$cat_img','$parent_id')";
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row center-box">
							...
							<div class="admin-txt-heading"><strong><h2>Add Category</h2></strong></div>
